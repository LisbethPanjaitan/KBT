...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Mulai perjalanan Anda bersama KBT</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input 
                        ...
                        required
                        value="{{ old('email') }}"
                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('email') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input 
                        ...
                        required
                        value="{{ old('phone') }}"
                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('phone') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="password" 
                        required
                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('password') border-red-500 @enderror"
            ...
            <div class="grid grid-cols-2 gap-3">
                <a href="{{ route('google.login') }}" class="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
